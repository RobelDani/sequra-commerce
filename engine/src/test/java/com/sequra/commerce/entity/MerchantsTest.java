...
import static com.sequra.commerce.EngineTestBeans.MERCHANTS;
...
class MerchantsTest {
    ...
    private static final Merchants EXPECTED_OBJECT = MERCHANTS;

    @Autowired
    private JacksonTester<Merchants> jacksonTester;
